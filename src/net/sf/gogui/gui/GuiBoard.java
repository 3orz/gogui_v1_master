...
// edit 21.06 add int shadow
// add setColorBackground()
// ---- 27.06 --- edit
// remove setColorBackground()
// add overwrite paintComponet();
    ...
    public void setBackground(int bg,int shadow)
    {
    m_painter.setBG(bg,shadow);
    }
    ...
    public void changeImageBackground(String name){
    imageBackground = m_painter.getImage(name);
    }
...
// --------   Modify  -------------
        ...
        {      
                ...
                || height != m_imageHeight)
            {
                ...
                // m_image = createImage(width, height); Remove..
                m_imageWidth = width;
                m_imageHeight = height;
                m_dirty = new Rectangle(0, 0, width, height);
            }
        //   add   //
        BufferedImage m_image = new BufferedImage(width, height,BufferedImage.TYPE_INT_ARGB);
        // add end //

        // add for transparent Panel
        m_panel.setBackground(new Color(0, 0, 0, 0));
        graphics.setColor(getBackground());
            Rectangle r = graphics.getClipBounds();
            graphics.fillRect(r.x, r.y, r.width, r.height);
        // add end
            drawImage(m_image);
            //graphics.drawImage(m_image, 0, 0, null); //Edit to ...
        graphics.drawImage(m_image,0,0,new Color(255, 0, 0,0), this);
        }
// -------  Modify End ---------- //
