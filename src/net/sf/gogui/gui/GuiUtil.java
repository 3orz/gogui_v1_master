...
//////////////////////////// ///////////////////////////////////////////////   
    ...
    public static Image getImage(String icon, String name)
    {
        String resource = "net/sf/gogui/images/" + icon + ".png";
        URL url = GuiUtil.class.getClassLoader().getResource(resource);
    ...
    public static ImageIcon getIconProfile(String icon, String name)
    {
        String resource = "net/sf/gogui/images/profile/" + icon + ".png";
        URL url = GuiUtil.class.getClassLoader().getResource(resource);
        return new ImageIcon(url, name);
    }

    public static ImageIcon scaleToRound(int WIDTH, int HEIGHT, Image image) {

        ImageIcon ii;
        BufferedImage bi = null;
        try {
            ii = new ImageIcon(image);//path to image
            bi = new BufferedImage(WIDTH, HEIGHT, BufferedImage.TYPE_INT_RGB);
            Graphics2D g2d = (Graphics2D) bi.createGraphics();
            g2d.addRenderingHints(new RenderingHints(RenderingHints.KEY_RENDERING,RenderingHints.VALUE_RENDER_QUALITY));
            g2d.drawImage(ii.getImage(), 0, 0, WIDTH, HEIGHT,Color.WHITE, null);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static BufferedImage makeRound(BufferedImage image, int cornerRadius) {
    ...
    public static ImageIcon scaleImage(int WIDTH, int HEIGHT, Image image) {
...
////////////////////////////////////////////////////////////////////////////
    ...
    public static void initLookAndFeel(String laf)
    {
        ...
        try
        {
            System.out.println("GoGui starts with"+laf+" look and feel ");//Print by Tom
