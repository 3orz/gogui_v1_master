...
public class BoardPainter
{
    public BoardPainter()
    {
        ...
        URL url = classLoader.getResource("net/sf/gogui/images/board-picture/wood.png");
        if (url == null)
            m_image = null;
        else
...
// ------- modify 20.06
// ------- edit directory foldar board-picture
// ------- modify 21.06
// ------- add images shadow
// ------- add color 
// edit 27
...
//
    ...
    {
	 ClassLoader classLoader = getClass().getClassLoader();
	 URL url = classLoader.getResource("net/sf/gogui/images/board-picture/" + name + ".png");
	 Image image = loadImage(url);
	 return image;

    }

    public void setBG(int noBG,int shadow)
    {
        ClassLoader classLoader = getClass().getClassLoader();
	URL url;
	...
	if(noBG == 0){
	    ...
	    if(shadow == 0)
		url = classLoader.getResource("net/sf/gogui/images/board-picture/wood.png");
	    else
		url = classLoader.getResource("net/sf/gogui/images/board-picture/wood-shadow.png");
	}
	    ...
	    if(shadow == 0)
		url = classLoader.getResource("net/sf/gogui/images/board-picture/marble.png");
	    else
		url = classLoader.getResource("net/sf/gogui/images/board-picture/marble-shadow.png");
	}

	else if(noBG == 3){

	    if(shadow == 0)
		url = classLoader.getResource("net/sf/gogui/images/board-picture/color-blue.png");
	    else
		url = classLoader.getResource("net/sf/gogui/images/board-picture/blue-shadow.png");
	}

	else if(noBG == 4){

	    if(shadow == 0)
		url = classLoader.getResource("net/sf/gogui/images/board-picture/color-green.png");
	    else
		url = classLoader.getResource("net/sf/gogui/images/board-picture/green-shadow.png");
	}

	else if(noBG == 5){

	    if(shadow == 0)
		url = classLoader.getResource("net/sf/gogui/images/board-picture/color-pink.png");
	    else
		url = classLoader.getResource("net/sf/gogui/images/board-picture/pink-shadow.png");
	}

	else if(noBG == 6){

	    if(shadow == 0)
		url = classLoader.getResource("net/sf/gogui/images/board-picture/color-w.png");
	    else
		url = classLoader.getResource("net/sf/gogui/images/board-picture/w-shadow.png");
	}

	else if(noBG == 7){

	    if(shadow == 0)
		url = classLoader.getResource("net/sf/gogui/images/board-picture/color-black.png");
	    else
		url = classLoader.getResource("net/sf/gogui/images/board-picture/black-shadow.png");
	}
...
//////////////////// insert End ////////////////////////////////////////////
    ...
    // ------------ 21.06.2016 modify BORDER_SIZE from 0.6 to 0.9
...
////////////// modify m_image : private final Image m_image; 
/**			     To private Image m_image;	     */
...
// to   int offset = (m_fieldSize + m_fieldOffset - 29) / 2;
    ...
    private void drawGridLabels(Graphics graphics)
    {
        ...
        int offset = (m_fieldSize + m_fieldOffset - 29) / 2;
        Point point;
        char c = 'A';
        for (int x = 0; x < m_size; ++x)
        {
